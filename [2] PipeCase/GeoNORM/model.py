...
class GeoModSpectralOperator(nn.Module):
    ...
    def __init__(self,
        ...
        self.encoder = MeshGCNEncoderTorch(2,self.C,self.Nk)
        self.eps = 1e-6
...
class Convolution_block(nn.Module):
    def __init__(self, 
        ...
        self.SpatialConv = SimpleGAT(num_channels, num_channels*2, num_channels)
...
class NORM_net(nn.Module):
    def __init__(self, modes, width, in_channel, out_channel):
        ...
        LBO_MATRIX = None
        LBO_INVERSE = None
        self.fc0 = nn.Linear(in_channel, self.width) 
